...
def permanence_node(g,community_map_to_node,node_map_to_community,node_v):
    """
    ...
    community_set = node_map_to_community[node_v]
    "When node_v is in a singleton community, permanence is zero"
    if len(community_set) == 1 and len(community_map_to_node[list(community_set)[0]]) == 1:
        return 0
    ...
    for community in community_set:
        ...
        if neighbor_set.issubset(community_map_to_node[community]):
        ...
        inner_node_set = neighbor_set & community_map_to_node[community]
        ...
        #    for node_e in external_node_set:
        #        print node_map_to_community[node_e]
        #                       
        #    print "node_v",node_v
        #    print "node_v_community",node_map_to_community[node_v]
...
def permanence(g,community_map_to_node,node_map_to_community):
    '''
    The input graph is undirected, unweighted graph.
